...
import { FreeToolsCreate } from '../../Context/Api_Base_Url';
...
const CreateFreeTools = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(FreeToolsCreate, formData, {
                ...
                <div className="row justify-content-center">
                    <div className="col-md-10">
                        <form className='shadow-sm bg-white px-5 pt-3 pb-4' onSubmit={handleSubmit}>
                            <h4 className='text-center py-4'>Create Free Tools</h4>
...
export default CreateFreeTools